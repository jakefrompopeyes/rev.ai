...
// Generate mock at-risk customers for demo
export function generateMockAtRiskCustomers(): AtRiskCustomer[] {
  const reasons: AtRiskCustomer['riskReason'][] = [
    'past_due',
    'failed_payment',
    'usage_drop',
    'downgrade_intent',
  ...
  return [
    ...
    },
    {
      ...
      mrr: 19900,
      riskReason: 'usage_drop',
      riskScore: 65,
      daysSinceIssue: 14,
    },
    {
      id: '4',
      email: 'billing@freelancer.dev',
      mrr: 2900,
